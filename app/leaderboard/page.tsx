    ...
    <main style={{ backgroundImage: "linear-gradient(rgba(7,19,39,0.62), rgba(7,19,39,0.90)), url('/images/clasament.webp')", backgroundSize: "cover", backgroundPosition: "center" }}>
      <AppShell>
        <section className="card p-6 md:p-8 bg-black/35">
          ...
          <div className="mt-3 text-white/85"><div>- 3 puncte pentru scor corect</div><div>- 1 punct pentru rezultat corect</div></div>
        </section>
        <div className="mt-6 overflow-x-auto rounded-3xl border border-white/10 bg-black/35 backdrop-blur">
