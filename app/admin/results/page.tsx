...
const LABELS: Record<string, string> = { groups1: "Etapa 1", groups2: "Etapa 2", groups3: "Etapa 3", round32: "32-imi", round16: "Optimi", quarter: "Sferturi", semi: "Semifinale", third: "Finala mică", final: "Finala" };
...
export default function AdminResultsPage() {
  ...
  const grouped = useMemo(() => {
    ...
    return {
      ...
      round32: all.filter((m) => m.stage === "round32"), round16: all.filter((m) => m.stage === "round16"), quarter: all.filter((m) => m.stage === "quarter"), semi: all.filter((m) => m.stage === "semi"), third: all.filter((m) => m.stage === "third"), final: all.filter((m) => m.stage === "final"),
    };
  }, []);
