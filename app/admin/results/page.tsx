...
import { useEffect, useState  Mexico: "🇲🇽",import { useEffect, useState, useCallback } from "react";
  "South Africa": "🇿🇦",
  "South Korea": "🇰🇷",
  Czechia: "🇨🇿",
  Canada: "🇨🇦",
                    ...
                    >
                      <div className="flex items-center justify-between border-b border-white/10 bg-white/5 px-4 py-2">
                        ...
                        <span className="text-xs text-white/30">
                          {matchPreds.length} pronosticuri
                        </span>
                      </div>
                      ...
                      <div className="divide-y divide-white/5">
                        {matchesForUsersTab.length === 0 ? (
                          <p className="px-4 py-3 text-xs text-white/40">
                            Nu există meciuri pentru această etapă.
                          </p>
                          ...
                          groupedMatchesForUsersTab.sections.map(
                            ([sectionKey, sectionMatches]) => {
